...
map.getView().fit([8479437.833722, 1181224.719209, 8493956.516281, 1191657.863904], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">MULAGUNNATHKAVU GRAMA PANCHAYAT</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (69 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Ms.SaniyaSabu  doing this work for mulamgunnathukavu grama panchayat.';
            }
